...
function App() {
  const data = [
    ["Uğur", "4", "0", "4", "0", "0", "0", "X", "X", "X", "3", "4", "3", "2", "0", "X", "3", "2"],
    ["Cemil", "1", "2", "0", "3", "0", "2", "0", "1", "2", "2", "2", "0", "1", "2", "X", "2", "X"],
    ["Güven", "1", "4", "1", "4", "1", "5", "3", "1", "2", "1" , "X", "1", "2", "3", "1", "1", "1"],
    ["Kamil", "1", "1", "X", "1", "4", "X", "0", "4", "1", "X", "1", "X", "X", "X", "X", "X", "X"],
    ["Serkan", "X", "0", "2", "0", "2", "0", "4", "0", "1", "1", "1", "5", "2", "1", "2", "1", "X"],
  ];
