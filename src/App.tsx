...
function App() {
  const data = [
    ["Uğur",   "2", "3", "0", "0", "2", "3", "4", "3", "X", "X", "X", "0", "0", "0", "4", "0", "4"],
    ["Cemil",  "0", "2", "0", "2", "1", "0", "2", "2", "2", "1", "0", "2", "0", "3", "0", "2", "1"], 
    ["Güven",  "1", "1", "1", "3", "2", "1", "X", "1", "2", "1", "3", "5", "1", "4", "1", "4", "1"],
    ["Kamil",  "X", "X", "X", "X", "X", "X", "1", "X", "1", "4", "0", "X", "4", "1", "X", "1", "1" ],
    ["Serkan", "0", "1", "2", "1", "2", "5", "1", "1", "1", "0", "4", "0", "2", "0", "2", "0", "X"],
  ];
